    ...
    <ul class="address_list">
        <li>
            ...
            <div class="addr_op">
                ...
                <a href="/admin/user/address_add?id=2"><i class="edit_icon"></i>编辑</a>
        ...
        <li>
            ...
            <div class="addr_op">
                ...
                <a href="/admin/user/address_add?id=1"><i class="edit_icon"></i>编辑</a>
                <span class="set_default" data="1">设为默认地址 </span>
            </div>
        </li>
    </ul>
    <div class="op_box">
        <a href="/admin/user/address_add" class="red_btn" style="color: #ffffff;">添加新地址</a>
    </div>
</div>