...
<div class="row m-t">
    <div class="col-lg-9 col-lg-offset-2 m-t">
        <dl class="dl-horizontal">
            ...
            <dt>品牌Logo</dt>
            <dd>
                <img class="img-circle circle-border" src="<?= UrlService::buildWwwUrl("/uploads/brand/20170301/a8887738ab1bfd71765dd063fee4ddaa.jpg"); ?>" style="width: 100px;height: 100px;" />
            </dd>
            <dt>联系电话</dt>
            <dd>12113021774</dd>
            <dt>地址</dt>
